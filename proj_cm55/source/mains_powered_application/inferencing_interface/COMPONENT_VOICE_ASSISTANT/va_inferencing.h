/******************************************************************************
* File Name : va_inferencing.h
*
* Description :
* Header for the DEEPCRAFT voice assistant (VA) inference processing
********************************************************************************
...
#ifndef _VA_INFERENCING_H_
#define _VA_INFERENCING_H_
